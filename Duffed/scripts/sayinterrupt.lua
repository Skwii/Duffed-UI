...
local function Update(self, event, ...)
	...
	if event == "COMBAT_LOG_EVENT_UNFILTERED" then
		...
		-- local channel = "SAY"
		local timestamp, eventType, hideCaster, sourceGUID, sourceName, sourceFlags, sourceFlags2, destGUID, destName, destFlags, spellID, spellName, _, extraskillID, extraSkillName = ...
